...
Generated at: 2026-05-08 15:03:10 UTC
...
| GET | `api/client/announcements/active` | Yes | Roles: Client | - |
...
| POST | `api/client/barcodes/confirm-mapping` | Yes | Policy: Client | - |
| POST | `api/client/barcodes/resolve` | Yes | Policy: Client | - |
...
| POST | `api/client/games/{challengeId:guid}/submit` | Yes | - | - |
| GET | `api/client/games/daily` | Yes | - | - |
...
| POST | `api/client/meal-logs/analyze-photo` | Yes | Roles: Client | kitchen-vision |
...
| DELETE | `api/client/recipes/{id:guid}/favorite` | Yes | - | - |
| POST | `api/client/recipes/{id:guid}/favorite` | Yes | - | - |
| GET | `api/client/recipes/{recipeId:guid}/plan-context` | Yes | Roles: Client | - |
| GET | `api/client/recipes/available` | Yes | - | - |
| GET | `api/client/recipes/favorites` | Yes | - | - |
| POST | `api/client/recipes/favorites/import` | Yes | - | - |
| GET | `api/client/recipes/favorites/summary` | Yes | - | - |
...
| GET | `api/dietitian/clients/{clientId:guid}/announcements` | Yes | Policy: Dietitian | - |
| POST | `api/dietitian/clients/{clientId:guid}/announcements` | Yes | Policy: Dietitian | dietitian-write |
| DELETE | `api/dietitian/clients/{clientId:guid}/announcements/{id:guid}` | Yes | Policy: Dietitian | dietitian-write |
| PUT | `api/dietitian/clients/{clientId:guid}/announcements/{id:guid}` | Yes | Policy: Dietitian | dietitian-write |
...
| GET | `api/dietitian/clients/{clientId:guid}/favorite-recipes` | Yes | - | - |
...
| DELETE | `api/dietitian/plans/{planId:guid}` | Yes | - | - |
| PATCH | `api/dietitian/plans/{planId:guid}` | Yes | - | - |
| POST | `api/dietitian/plans/{planId:guid}/deactivate` | Yes | - | - |
| POST | `api/dietitian/plans/{planId:guid}/reactivate` | Yes | - | - |
...
| GET | `api/dietitian/recipe-favorites/overview` | Yes | - | - |
