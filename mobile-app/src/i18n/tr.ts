...
export const tr = {
  ...
  welcome: {
    ...
    termsSuffix: '\'nı kabul edersiniz',
    feature1:    'Kişisel Plan',
    feature2:    'Tarif Motoru',
    feature3:    'İlerleme',
  },
  ...
  dashboard: {
    ...
    compliance:        'GÜNLÜK UYUM',
    compliancePerfect: 'Mükemmel',
    complianceGreat:   'Çok İyi',
    ...
    // Action buttons
    actionPlans:      'Planım',
    actionKitchen:    'Mutfak',
    actionMeasures:   'Ölçümler',
    actionMessages:   'Notlarım',
    actionPremium:    'Premium',
    actionRecipes:    'Tarif Bul',
    actionCopyId:     'ID Kopyala',

    // Next meal
    nextMeal:         'Sonraki Öğün',
    noMeals:          'Bugün için öğün yok',
  ...
  plans: {
    ...
    nextMeal:         'Sıradaki Öğün',
    completed:        'Tamamlandı',
    pending:          'Bekliyor',
    skipped:          'Atlandı',
    sectionPending:   'BEKLEYEN',
    sectionDone:      'TAMAMLANAN',
    sectionSkipped:   'ATLANAN',
    complete:         'Tamamla',
    skip:             'Atla',
    undo:             'Geri Al',
  ...
  kitchen: {
    ...
    scanCamera:       'Kamera ile Tara',
    findRecipes:      'Tarif Bul',
    noIngredients:    'Malzeme seçilmedi',
    noIngredientsDesc:'Malzeme seçerek başla',
    selected:         'seçildi',
    packs:            'Paketler',
  ...
  profile: {
    ...
    noDietitian:      'Diyetisyen Bağlı Değil',
    clinic:           'Klinik',
    measurements:     'Ölçümlerim',
    measurementsDesc: 'Bel, kalça, göğüs takibi',
    theme:            'Tema',
    themeLight:       'Aydınlık',
    themeDark:        'Karanlık',
    themeSystem:      'Sistem',
  ...
  measurements: {
    ...
    chestLabel: 'Göğüs',
    saved:      'Kaydedildi',
    savedDesc:  'Ölçümünüz başarıyla kaydedildi.',
    invalid:    'Geçersiz',
    invalidMin: 'En az bir ölçüm giriniz',
    invalidRange: 'Ölçümler 0 ile 300 cm arasında olmalıdır.',
